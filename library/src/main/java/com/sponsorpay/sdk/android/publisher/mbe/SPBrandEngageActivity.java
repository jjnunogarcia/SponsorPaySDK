...
public class SPBrandEngageActivity extends Activity implements SPBrandEngageClientStatusListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			...
			SPBrandEngageClient.INSTANCE.playThroughMediation(new ValueCallback<Boolean>() {
				@Override
				public void onReceiveValue(Boolean value) {
					mPlayThroughMediation = value;
					startEngagement();
				}
			});
		}
	...
	protected void setResultAndClose(String intentExtra) {
