...
public abstract class SPMediationAdapter {
   ...
   *
   * @param activity The parent activity calling this method
   * @return true if the adapter was successfully started, false otherwise
   */
  ...
  public void validateVideoNetwork(Context context, SPMediationValidationEvent validationEvent, HashMap<String, String> contextData) {
  ...
  public void startVideoEngagement(Activity parentActivity, SPMediationVideoEvent engagementEvent, HashMap<String, String> contextData) {
    // validation is not required here, as SPMediationCoordinator is performing it before, but...
    SPBrandEngageMediationAdapter<? extends SPMediationAdapter> videoMediationAdapter = getVideoMediationAdapter();
    if (videoMediationAdapter != null) {
