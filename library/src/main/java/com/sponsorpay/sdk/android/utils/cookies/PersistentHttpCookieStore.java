package com.sponsorpay.sdk.android.utils.cookies;
...
public class PersistentHttpCookieStore implements CookieStore {
    ...
    private static final String COOKIE_PREFS = "SponsorPayCookiePrefsFile";
    ...
    public PersistentHttpCookieStore(Context context) {
        ...
        map = Collections.synchronizedMap(new HashMap<URI, List<HttpCookie>>());
