...
import com.sponsorpay.sdk.android.publisher.currency.SPCurrencyServerRequester.SPVCSResultListener;
...
public class SPVirtualCurrencyConnector implements SPVCSResultListener {
   ...
   * @param credentialsToken       The token identifying the {@link SPCredentials} to be used.
   * @param currencyServerListener {@link SPCurrencyServerListener} registered by the developer
   ...
   *
   * @param currency the custom currency name
   * @return
   */
   ...
   *
   * @param transactionId Optionally, provide the ID of the latest known transaction. The delta of coins
   ...
   * @param currencyId    Optionally, provide the ID of the currency that you want to retrieve. If the provided
   ...
   *
   * @param successfulResponse Saves the response that has been received from the server into the shared preferences,
   ...
   *
   * @param context          Android application context.
   * @param credentialsToken The credentials token.
   * @return The retrieved transaction ID or null.
   */
   ...
   * @param currencyId  If it's null or empty, then use the currency ID that has been
