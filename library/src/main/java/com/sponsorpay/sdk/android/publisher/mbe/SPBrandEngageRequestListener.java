...
public interface SPBrandEngageRequestListener {
   ...
   *
   * @param spBrandEngageActivity The intent for the {@link SPBrandEngageActivity} that can launched for starting the engagement.
   */
   ...
   * network.
   *
   * @param errorMessage The description of the error for the request.
   */
