...
public abstract class SPBrandEngageMediationAdapter<V extends SPMediationAdapter> {
   ...
   *
   * @param parentActivity If the wrapped SDK needs a parent activity, it can use the provided one.
   */
   ...
   * @param event       The {@link SPMediationValidationEvent} to be notified.
   * @param contextData The context data used in this request
   */
   ...
   * @param event          The {@link SPMediationVideoEvent} to be notified.
   * @param contextData    The context data used in this request
   */
   ...
   * adapter to be sent.
   *
   * @param result The {@link SPTPNVideoEvent} to be sent.
   */
   ...
   *
   * @param event The {@link SPTPNVideoEvent} to be sent.
   */
