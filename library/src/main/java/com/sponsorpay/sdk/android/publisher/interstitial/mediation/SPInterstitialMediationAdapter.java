...
public abstract class SPInterstitialMediationAdapter<V extends SPMediationAdapter> {
   ...
   * @return boolean indicating that the ad was successfully shown to the user
   */
   ...
   *
   * @param context The activity context
   * @param ad      The {@link SPInterstitialAd} for this query.
   * @return true is an ad is available
   */
   ...
   * @param ad             The {@link SPInterstitialAd} for this query.
   * @return Boolean indicating that the ad was shown
   */
  public boolean show(Activity parentActivity, SPInterstitialAd ad) {
    if (isAdAvailable()) {
