...
public class SPInterstitialClient {
   ...
   *
   * @param ad the ad to be validated
   ...
   *
   * @param parentActivity The activity that will be used to show the engagement
   ...
   *
   * @param ad    the ad to which the event is related
