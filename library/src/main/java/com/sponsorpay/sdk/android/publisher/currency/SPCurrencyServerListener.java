...
public interface SPCurrencyServerListener {
   ...
   *
   * @param response An instance of {@link SPCurrencyServerErrorResponse} which describes the error.
   */
   ...
   *
   * @param response An instance of {@link SPCurrencyServerSuccessfulResponse} holding the amount of currency earned for
